...
public interface Index {
   ...
   * is set to {@code true} on a {@link SearchService#getIndexes} request
   */
  Schema getSchema();

  /**
   * @return a rough approximation of the amount of storage space
   * currently used by this index, expressed in bytes
   * @throws UnsupportedOperationException if called on an Index
  ...
  /**
   * @return the maximum amount of storage space that the application
   * may use in this index, expressed in bytes
   * @throws UnsupportedOperationException if called on an Index
   * object that is not the result of a
