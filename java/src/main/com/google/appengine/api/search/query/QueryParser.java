...
public class QueryParser extends Parser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "ARGS", "CONJUNCTION", "DISJUNCTION", "FUNCTION", "FUZZY", "GLOBAL", "LITERAL", "NEGATION", "STRING", "SEQUENCE", "VALUE", "WS", "LE", "LESSTHAN", "GE", "GT", "NE", "EQ", "HAS", "LPAREN", "RPAREN", "AND", "OR", "NOT", "DISTANCE_FN", "GEO_POINT_FN", "FIX", "REWRITE", "TEXT", "QUOTE", "ESC", "UNICODE_ESC", "OCTAL_ESC", "CHAR_SEQ", "DIGIT", "MID_CHAR", "ESCAPED_CHAR", "START_CHAR", "HEX_DIGIT", "'-'", "','", "'\\\\'"
    };
    ...
    public final QueryParser.query_return query() throws RecognitionException {
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    {
            	    WS1=(Token)match(input,WS,FOLLOW_WS_in_query130);
            	    stream_WS.add(WS1);
            ...
            do {
            	...
            	case 1 :
            	    {
            	    WS3=(Token)match(input,WS,FOLLOW_WS_in_query135);
            	    stream_WS.add(WS3);
            ...
            EOF4=(Token)match(input,EOF,FOLLOW_EOF_in_query138);
            stream_EOF.add(EOF4);
    ...
    public final QueryParser.expression_return expression() throws RecognitionException {
        ...
        try {
            {
            pushFollow(FOLLOW_sequence_in_expression157);
            sequence5=sequence();
            ...
            do {
            	...
            	case 1 :
            	    {
            	    pushFollow(FOLLOW_andOp_in_expression160);
            	    andOp6=andOp();

            	    state._fsp--;

            	    stream_andOp.add(andOp6.getTree());
            	    pushFollow(FOLLOW_sequence_in_expression162);
            	    sequence7=sequence();
    ...
    public final QueryParser.sequence_return sequence() throws RecognitionException {
        ...
        try {
            {
            pushFollow(FOLLOW_factor_in_sequence188);
            factor8=factor();
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    do {
            	    	...
            	    	case 1 :
            	    	    {
            	    	    WS9=(Token)match(input,WS,FOLLOW_WS_in_sequence191);
            	    	    stream_WS.add(WS9);
            	    ...
            	    pushFollow(FOLLOW_factor_in_sequence194);
            	    factor10=factor();
    ...
    public final QueryParser.factor_return factor() throws RecognitionException {
        ...
        try {
            {
            pushFollow(FOLLOW_term_in_factor220);
            term11=term();
            ...
            do {
            	...
            	case 1 :
            	    {
            	    pushFollow(FOLLOW_orOp_in_factor223);
            	    orOp12=orOp();

            	    state._fsp--;

            	    stream_orOp.add(orOp12.getTree());
            	    pushFollow(FOLLOW_term_in_factor225);
            	    term13=term();
    ...
    public final QueryParser.term_return term() throws RecognitionException {
        ...
        try {
            ...
            switch (alt7) {
                case 1 :
                    {
                    pushFollow(FOLLOW_notOp_in_term249);
                    notOp14=notOp();

                    state._fsp--;

                    stream_notOp.add(notOp14.getTree());
                    pushFollow(FOLLOW_primitive_in_term251);
                ...
                case 2 :
                    ...
                    pushFollow(FOLLOW_primitive_in_term265);
    ...
    public final QueryParser.primitive_return primitive() throws RecognitionException {
        ...
        QueryParser.restriction_return restriction17 = null;
        ...
        try {
            ...
            switch (alt8) {
                case 1 :
                    ...
                    pushFollow(FOLLOW_restriction_in_primitive281);
                    restriction17=restriction();

                    state._fsp--;

                    adaptor.addChild(root_0, restriction17.getTree());
                ...
                case 2 :
                    ...
                    pushFollow(FOLLOW_composite_in_primitive287);
                ...
                case 3 :
                    {
                    pushFollow(FOLLOW_item_in_primitive293);
                    item19=item();
    ...
    public final QueryParser.restriction_return restriction() throws RecognitionException {
        ...
        try {
            {
            pushFollow(FOLLOW_comparable_in_restriction319);
            comparable20=comparable();

            state._fsp--;

            stream_comparable.add(comparable20.getTree());
            pushFollow(FOLLOW_comparator_in_restriction321);
            comparator21=comparator();

            state._fsp--;

            stream_comparator.add(comparator21.getTree());
            pushFollow(FOLLOW_arg_in_restriction323);
            arg22=arg();
    ...
    public final QueryParser.comparator_return comparator() throws RecognitionException {
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    {
            	    WS23=(Token)match(input,WS,FOLLOW_WS_in_comparator347);
            	    stream_WS.add(WS23);
            ...
            switch (alt10) {
                case 1 :
                    {
                    x=(Token)match(input,LE,FOLLOW_LE_in_comparator353);
                    stream_LE.add(x);
                ...
                case 2 :
                    {
                    x=(Token)match(input,LESSTHAN,FOLLOW_LESSTHAN_in_comparator359);
                ...
                case 3 :
                    {
                    x=(Token)match(input,GE,FOLLOW_GE_in_comparator365);
                    stream_GE.add(x);
                ...
                case 4 :
                    {
                    x=(Token)match(input,GT,FOLLOW_GT_in_comparator371);
                    stream_GT.add(x);
                ...
                case 5 :
                    {
                    x=(Token)match(input,NE,FOLLOW_NE_in_comparator377);
                    stream_NE.add(x);
                ...
                case 6 :
                    {
                    x=(Token)match(input,EQ,FOLLOW_EQ_in_comparator383);
                    stream_EQ.add(x);
                ...
                case 7 :
                    {
                    x=(Token)match(input,HAS,FOLLOW_HAS_in_comparator389);
                    stream_HAS.add(x);
            ...
            do {
            	...
            	case 1 :
            	    {
            	    WS24=(Token)match(input,WS,FOLLOW_WS_in_comparator392);
            	    stream_WS.add(WS24);
        ...
        try {
            ...
            switch (alt12) {
                case 1 :
                    ...
                    pushFollow(FOLLOW_item_in_comparable414);
                    item25=item();
                ...
                case 2 :
                    ...
                    pushFollow(FOLLOW_function_in_comparable420);
                    function26=function();
    ...
    public final QueryParser.function_return function() throws RecognitionException {
        ...
        try {
            {
            pushFollow(FOLLOW_fnname_in_function435);
            fnname27=fnname();

            state._fsp--;

            stream_fnname.add(fnname27.getTree());
            LPAREN28=(Token)match(input,LPAREN,FOLLOW_LPAREN_in_function437);
            stream_LPAREN.add(LPAREN28);

            pushFollow(FOLLOW_arglist_in_function439);
            arglist29=arglist();

            state._fsp--;

            stream_arglist.add(arglist29.getTree());
            RPAREN30=(Token)match(input,RPAREN,FOLLOW_RPAREN_in_function441);
            ...
            switch (alt14) {
                case 1 :
                    ...
                    do {
                    	...
                    	case 1 :
                    	    {
                    	    pushFollow(FOLLOW_sep_in_arglist473);
                    	    sep32=sep();
    ...
    public final QueryParser.arg_return arg() throws RecognitionException {
        ...
        try {
            ...
            case GEO_POINT_FN:
                ...
                if ( (LA15_3==EOF||LA15_3==WS||LA15_3==RPAREN||LA15_3==44) ) {
                    alt15=1;
                }
                else if ( (LA15_3==LPAREN) ) {
                    alt15=3;
                }
                else {
                    NoViableAltException nvae =
            ...
            switch (alt15) {
                case 1 :
                    ...
                    pushFollow(FOLLOW_item_in_arg500);
                    item34=item();
                ...
                case 2 :
                    ...
                    pushFollow(FOLLOW_composite_in_arg506);
                ...
                case 3 :
                    ...
                    pushFollow(FOLLOW_function_in_arg512);
                    function36=function();
    ...
    public final QueryParser.andOp_return andOp() throws RecognitionException {
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    {
            	    WS37=(Token)match(input,WS,FOLLOW_WS_in_andOp526);
            ...
            AND38=(Token)match(input,AND,FOLLOW_AND_in_andOp529);
            ...
            do {
            	...
            	case 1 :
            	    {
            	    WS39=(Token)match(input,WS,FOLLOW_WS_in_andOp531);
    ...
    public final QueryParser.orOp_return orOp() throws RecognitionException {
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    {
            	    WS40=(Token)match(input,WS,FOLLOW_WS_in_orOp546);
            ...
            OR41=(Token)match(input,OR,FOLLOW_OR_in_orOp549);
            ...
            do {
            	...
            	case 1 :
            	    {
            	    WS42=(Token)match(input,WS,FOLLOW_WS_in_orOp551);
        ...
        try {
            ...
            switch (alt21) {
                case 1 :
                    ...
                    char_literal43=(Token)match(input,43,FOLLOW_43_in_notOp566);
                ...
                case 2 :
                    ...
                    NOT44=(Token)match(input,NOT,FOLLOW_NOT_in_notOp572);
                    ...
                    do {
                    	...
                    	case 1 :
                    	    {
                    	    WS45=(Token)match(input,WS,FOLLOW_WS_in_notOp574);
    ...
    public final QueryParser.sep_return sep() throws RecognitionException {
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    {
            	    WS46=(Token)match(input,WS,FOLLOW_WS_in_sep589);
            ...
            char_literal47=(Token)match(input,44,FOLLOW_44_in_sep592);
            ...
            do {
            	...
            	case 1 :
            	    {
            	    WS48=(Token)match(input,WS,FOLLOW_WS_in_sep594);
    ...
    public final QueryParser.composite_return composite() throws RecognitionException {
        ...
        try {
            {
            LPAREN50=(Token)match(input,LPAREN,FOLLOW_LPAREN_in_composite630);
            ...
            do {
            	...
            	case 1 :
            	    {
            	    WS51=(Token)match(input,WS,FOLLOW_WS_in_composite632);
            	    stream_WS.add(WS51);
            ...
            pushFollow(FOLLOW_expression_in_composite635);
            ...
            do {
            	...
            	case 1 :
            	    {
            	    WS53=(Token)match(input,WS,FOLLOW_WS_in_composite637);
            	    stream_WS.add(WS53);
            ...
            RPAREN54=(Token)match(input,RPAREN,FOLLOW_RPAREN_in_composite640);
    ...
    public final QueryParser.item_return item() throws RecognitionException {
        ...
        try {
            ...
            switch (alt26) {
                case 1 :
                    {
                    FIX55=(Token)match(input,FIX,FOLLOW_FIX_in_item660);
                    stream_FIX.add(FIX55);

                    pushFollow(FOLLOW_value_in_item662);
                    value56=value();
                ...
                case 2 :
                    {
                    REWRITE57=(Token)match(input,REWRITE,FOLLOW_REWRITE_in_item676);
                    stream_REWRITE.add(REWRITE57);

                    pushFollow(FOLLOW_value_in_item678);
                    value58=value();
                ...
                case 3 :
                    {
                    pushFollow(FOLLOW_value_in_item692);
                    value59=value();
    ...
    public final QueryParser.value_return value() throws RecognitionException {
        ...
        try {
            ...
            switch (alt27) {
                case 1 :
                    {
                    pushFollow(FOLLOW_text_in_value710);
                    text60=text();
                ...
                case 2 :
                    {
                    pushFollow(FOLLOW_phrase_in_value726);
                    phrase61=phrase();
    ...
    public final QueryParser.text_return text() throws RecognitionException {
        ...
        RewriteRuleTokenStream stream_GEO_POINT_FN=new RewriteRuleTokenStream(adaptor,"token GEO_POINT_FN");
        RewriteRuleTokenStream stream_DISTANCE_FN=new RewriteRuleTokenStream(adaptor,"token DISTANCE_FN");
        ...
        try {
            ...
            switch (alt28) {
                case 1 :
                    ...
                    TEXT62=(Token)match(input,TEXT,FOLLOW_TEXT_in_text750);
                ...
                case 2 :
                    {
                    t=(Token)match(input,DISTANCE_FN,FOLLOW_DISTANCE_FN_in_text761);
                    ...
                    root_0 = (CommonTree)adaptor.nil();
                    {
                        adaptor.addChild(root_0, (CommonTree)adaptor.create(TEXT, t));
                ...
                case 3 :
                    {
                    t=(Token)match(input,GEO_POINT_FN,FOLLOW_GEO_POINT_FN_in_text774);
    ...
    public final QueryParser.phrase_return phrase() throws RecognitionException {
        ...
        try {
            ...
            QUOTE63=(Token)match(input,QUOTE,FOLLOW_QUOTE_in_phrase793);
            ...
            do {
                ...
                if ( ((LA29_0>=ARGS && LA29_0<=TEXT)||(LA29_0>=ESC && LA29_0<=44)) ) {
                    alt29=1;
                }
            ...
            QUOTE65=(Token)match(input,QUOTE,FOLLOW_QUOTE_in_phrase811);
    ...
    class DFA3 extends DFA {
        ...
        public String getDescription() {
            return "()* loopback of 65:14: ( andOp sequence )*";
        }
    }
    ...
    class DFA5 extends DFA {
        ...
        public String getDescription() {
            return "()* loopback of 71:12: ( ( WS )+ factor )*";
        }
    }
    ...
    class DFA6 extends DFA {
        ...
        public String getDescription() {
            return "()* loopback of 77:10: ( orOp term )*";
        }
    }
    static final String DFA8_eotS =
        "\31\uffff";
    static final String DFA8_eofS =
        "\3\uffff\3\22\2\uffff\3\22\1\uffff\3\22\1\uffff\1\22\3\uffff\1\22"+
        "\1\uffff\1\22\1\uffff\1\22";
    static final String DFA8_minS =
        "\1\27\2\34\3\17\1\4\1\uffff\3\17\1\4\3\17\1\4\1\17\2\uffff\1\4\1"+
        "\17\1\4\1\17\1\4\1\17";
    ...
    static final String[] DFA8_transitionS = {
            "\1\7\4\uffff\1\4\1\5\1\1\1\2\1\3\1\6",
            "\1\11\1\12\2\uffff\1\10\1\13",
            "\1\15\1\16\2\uffff\1\14\1\17",
            "\1\20\7\21\1\uffff\1\22",
            "\1\20\10\21\1\22",
            "\1\20\10\21\1\22",
            "\35\23\1\24\13\23",
    ...
    class DFA8 extends DFA {
        ...
        public String getDescription() {
            return "88:1: primitive : ( restriction | composite | item -> ^( HAS GLOBAL item ) );";
        }
    }

    public static final BitSet FOLLOW_WS_in_query130 = new BitSet(new long[]{0x00000803F8808000L});
    public static final BitSet FOLLOW_expression_in_query133 = new BitSet(new long[]{0x0000000000008000L});
    public static final BitSet FOLLOW_WS_in_query135 = new BitSet(new long[]{0x0000000000008000L});
    public static final BitSet FOLLOW_EOF_in_query138 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_sequence_in_expression157 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_andOp_in_expression160 = new BitSet(new long[]{0x00000803F8800000L});
    public static final BitSet FOLLOW_sequence_in_expression162 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_factor_in_sequence188 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_WS_in_sequence191 = new BitSet(new long[]{0x00000803F8808000L});
    public static final BitSet FOLLOW_factor_in_sequence194 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_term_in_factor220 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_orOp_in_factor223 = new BitSet(new long[]{0x00000803F8800000L});
    public static final BitSet FOLLOW_term_in_factor225 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_notOp_in_term249 = new BitSet(new long[]{0x00000803F8800000L});
    public static final BitSet FOLLOW_primitive_in_term251 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_primitive_in_term265 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_restriction_in_primitive281 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_composite_in_primitive287 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_item_in_primitive293 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_comparable_in_restriction319 = new BitSet(new long[]{0x00000000007F8000L});
    public static final BitSet FOLLOW_comparator_in_restriction321 = new BitSet(new long[]{0x00000003F0800000L});
    public static final BitSet FOLLOW_arg_in_restriction323 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_WS_in_comparator347 = new BitSet(new long[]{0x00000000007F8000L});
    public static final BitSet FOLLOW_LE_in_comparator353 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_LESSTHAN_in_comparator359 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_GE_in_comparator365 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_GT_in_comparator371 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_NE_in_comparator377 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_EQ_in_comparator383 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_HAS_in_comparator389 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_WS_in_comparator392 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_item_in_comparable414 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_function_in_comparable420 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_fnname_in_function435 = new BitSet(new long[]{0x0000000000800000L});
    public static final BitSet FOLLOW_LPAREN_in_function437 = new BitSet(new long[]{0x00000003F1800000L});
    public static final BitSet FOLLOW_arglist_in_function439 = new BitSet(new long[]{0x0000000001000000L});
    public static final BitSet FOLLOW_RPAREN_in_function441 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_arg_in_arglist470 = new BitSet(new long[]{0x0000100000008002L});
    public static final BitSet FOLLOW_sep_in_arglist473 = new BitSet(new long[]{0x00000003F0800000L});
    public static final BitSet FOLLOW_arg_in_arglist475 = new BitSet(new long[]{0x0000100000008002L});
    public static final BitSet FOLLOW_item_in_arg500 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_composite_in_arg506 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_function_in_arg512 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_WS_in_andOp526 = new BitSet(new long[]{0x0000000002008000L});
    public static final BitSet FOLLOW_AND_in_andOp529 = new BitSet(new long[]{0x0000000000008000L});
    public static final BitSet FOLLOW_WS_in_andOp531 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_WS_in_orOp546 = new BitSet(new long[]{0x0000000004008000L});
    public static final BitSet FOLLOW_OR_in_orOp549 = new BitSet(new long[]{0x0000000000008000L});
    public static final BitSet FOLLOW_WS_in_orOp551 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_43_in_notOp566 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NOT_in_notOp572 = new BitSet(new long[]{0x0000000000008000L});
    public static final BitSet FOLLOW_WS_in_notOp574 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_WS_in_sep589 = new BitSet(new long[]{0x0000100000008000L});
    public static final BitSet FOLLOW_44_in_sep592 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_WS_in_sep594 = new BitSet(new long[]{0x0000000000008002L});
    public static final BitSet FOLLOW_set_in_fnname0 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LPAREN_in_composite630 = new BitSet(new long[]{0x00000803F8808000L});
    public static final BitSet FOLLOW_WS_in_composite632 = new BitSet(new long[]{0x00000803F8808000L});
    public static final BitSet FOLLOW_expression_in_composite635 = new BitSet(new long[]{0x0000000001008000L});
    public static final BitSet FOLLOW_WS_in_composite637 = new BitSet(new long[]{0x0000000001008000L});
    public static final BitSet FOLLOW_RPAREN_in_composite640 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_FIX_in_item660 = new BitSet(new long[]{0x00000003F0000000L});
    public static final BitSet FOLLOW_value_in_item662 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_REWRITE_in_item676 = new BitSet(new long[]{0x00000003F0000000L});
    public static final BitSet FOLLOW_value_in_item678 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_value_in_item692 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_text_in_value710 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_phrase_in_value726 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_TEXT_in_text750 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_DISTANCE_FN_in_text761 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_GEO_POINT_FN_in_text774 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_QUOTE_in_phrase793 = new BitSet(new long[]{0x00001FFFFFFFFFF0L});
    public static final BitSet FOLLOW_set_in_phrase795 = new BitSet(new long[]{0x00001FFFFFFFFFF0L});
    public static final BitSet FOLLOW_QUOTE_in_phrase811 = new BitSet(new long[]{0x0000000000000002L});
