...
public class AppAdminFactory {
   ...
   *
   * @param allowAnyRuntime {@code true} to allow an arbitrary runtime id value,
   *        {@code false} to validate it against the list of supported runtimes.
   */
   ...
   *
   * @param fail {@code true} to abort an update if precompilation fails,
   * {@code false} to treat it as a warning and continue updating the application.
   */
