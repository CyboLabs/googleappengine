...
public final class ResourceLimits {
   ...
   *
   * @param clientDeploySender A clientDeploySender for performing and logging adminconsole
   *                           requests.
   *
   ...
   * server.
   */
  public static ResourceLimits request(ClientDeploySender clientDeploySender,
      GenericApplication app) throws IOException {
    Map<String, Long> remoteResourceLimits = remoteRequest(clientDeploySender, app);
   ...
   * server.
   */
  private static Map<String, Long> remoteRequest(ClientDeploySender clientDeploySender,
      GenericApplication app) throws IOException {
    String reply = null;
    try {
      reply = clientDeploySender.send("/api/appversion/getresourcelimits", "",
  ...
  /**
   * Creates and returns a {@link ResourceLimits} with default values
   * for testing.
   */
