...
public interface ServerConnection {
  ...
  String get(String url, Multimap<String, String> params) throws IOException;

  String post(String url, File payload, String contentType, Map<String, String> params)
      throws IOException;

  String post(String url, File payload, String contentType, Multimap<String, String> params)
      throws IOException;
  ...
  String post(String url, String payload, Multimap<String, String> params) throws IOException;
