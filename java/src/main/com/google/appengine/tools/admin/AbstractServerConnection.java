...
public abstract class AbstractServerConnection implements ServerConnection {
  ...
  protected String buildQuery(Map<String, String> params) throws UnsupportedEncodingException {
    return buildQuery(Multimaps.forMap(params));
  }

  protected String buildQuery(Multimap<String, String> params) throws UnsupportedEncodingException {
  ...
  public String get(String url, Map<String, String> params) throws IOException {
    return send(GET, url, null, null, Multimaps.forMap(params));
  }

  @Override
  public String get(String url, Multimap<String, String> params) throws IOException {
  ...
  public String post(String url, File payload, String contentType, Map<String, String> params)
      throws IOException {
    return send(POST, url, new FilePoster(payload), contentType, Multimaps.forMap(params));
  }

  @Override
  public String post(String url, File payload, String contentType, Multimap<String, String> params)
      throws IOException {
    return send(POST, url, new FilePoster(payload), contentType, params);
  }

  protected InputStream postAndGetInputStream(String url, DataPoster poster, String... params)
      throws IOException {
    return send1(POST, url, poster, null, Multimaps.forMap(getParamMap(params)));
  }

  @Override
  public String post(String url, File payload, String contentType, String... params)
      throws IOException {
    return send(POST, url, new FilePoster(payload), contentType,
        Multimaps.forMap(getParamMap(params)));
  }
  ...
  @Override
  public String post(String url, String payload, Map<String, String> params)
      throws IOException {
    return send(POST, url, new StringPoster(payload), null, Multimaps.forMap(params));
  }

  @Override
  public String post(String url, String payload, Multimap<String, String> params)
      throws IOException {
  ...
  public String post(String url, String payload, String... params) throws IOException {
    return send(POST, url, new StringPoster(payload), null, Multimaps.forMap(getParamMap(params)));
  }
  ...
  public InputStream postAndGetInputStream(String url, String payload, String... params)
    throws IOException {
    return send1(POST, url, new StringPoster(payload), null, Multimaps.forMap(getParamMap(params)));
  }
  ...
  protected String send(String method, String path, DataPoster payload, String content_type,
                        Multimap<String, String> params) throws IOException {
  ...
  private InputStream send1(String method, String path, DataPoster payload, String content_type,
    ...
    while (true) {
      ...
      if (status == HttpURLConnection.HTTP_OK) {
        ...
        String httpErrorMessage = constructHttpErrorMessage(
            conn,
            new BufferedReader(new StringReader(response)));
        logger.warning(httpErrorMessage + "This is try #" + tries);
        if (++tries > MAX_SEND_RETRIES) {
          throw new HttpIoException(httpErrorMessage, status);
        }
        doHandleSendErrors(status, url, conn, new BufferedReader(new StringReader(response)));
      }
    }
  }
