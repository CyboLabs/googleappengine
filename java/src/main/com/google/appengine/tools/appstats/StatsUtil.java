...
class StatsUtil {
    ...
    return new Comparator<List<Object>>() {
      ...
      public int compare(List<Object> o1, List<Object> o2) {
        ...
        for (int i : fieldOrder) {
          Comparable<Object> c1 = (Comparable<Object>) o1.get(i);
          Comparable<Object> c2 = (Comparable<Object>) o2.get(i);
  ...
  static Map<String, Object> createSummaryStats(List<RequestStatProto> records) {
    ...
    for (RpcStats rpcStats : statsByRpc.values()) {
      ...
      Collections.addAll(
          ...
          rpcStats.rpcName,
          rpcStats.numRpcs,
          rpcStats.rpcCostMicropennies,
          rpcStats.billedOps,
          asPercentageOf(rpcStats.rpcCostMicropennies, totalCostMicropennies),
          pathStatsTupleOrderedByRpc);
    ...
    for (PathStats pathStats : statsByPath.values()) {
      ...
      Collections.addAll(
          ...
          rpcCostMicropennies,
          pathStats.billedOps,
          asPercentageOf(rpcCostMicropennies, totalCostMicropennies),
          pathStats.requestIds.size(),
          pathStats.requestIds,
          rpcStatsTupleOrderedByPath);
  ...
  static Map<String, Object> createDetailedStats(RequestStatProto data) {
    ...
    for (Map.Entry<String, DetailedRpcStats> entry : statsByRpc.entrySet()) {
      ...
      Collections.addAll(
          tuple,
          detailedStats.numRpcs,
          detailedStats.durationMillis,
          megaCyclesToMilliseconds(detailedStats.apiMcycles),
          detailedStats.rpcCostMicropennies,
          detailedStats.billedOps);
